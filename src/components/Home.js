...
import MyImgbw from "../assets/MyImgbw.png";
...
const Home = ({ scrollToAbout }) => {
  ...
  return (
    <div id='home'>
      <animated.div className='home-container neumorphic-box' style={fadeIn}>
        <div className='home-p'>
          <div className='home-pic neumorphic-box'>
            <img src={MyImgbw} alt='' className='neumorphic-image' />
          </div>
          <div className='home-name'>
            <h1 className='Hi neumorphic-text'>Hi, I'm Sai Achuth!</h1>
            <p className='mern neumorphic-text'>MERN developer</p>
            <p className='mern-desc neumorphic-text'>
            ...
            <ul className='icons-list'>
              ...
              <li>
                <a href='mailto:saiacx27@gmail.com'>
                  <svg
                    height='48'
                    width='48'
                    viewBox='0 0 48 48'
